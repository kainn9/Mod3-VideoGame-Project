...
let gameConfig = {
    ...
    physics: {
        ...
        arcade: {
            ...
            gravity: { y: 80 }, // will affect our player sprite
            debug: false
        }
    }
};
...
const loadGameShop = () => {
    //shop stuff goes here
    console.log('shop is wired. fn is loaded');
}
...
const resetPlayerItemsOnDeath = () => {
    ...
    }).then(resp => resp.json()).then(emptyInv => {
...
// rendering the item info div  ### Returning double the items for some reason????
